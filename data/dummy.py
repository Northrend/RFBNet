...
class DummyDetection(data.Dataset):

    """Dummy Detection Dataset Object
    ...
    Annotation structure:
        ...
        train['images'][0]:
            {'coco_url': None,
             'date_captured': None,
             'file_name': 'Image_00000002.jpg',
             'flickr_url': None,
             'height': 200,
             'id': 'Image_00000002.jpg',
             'license': None,
             'width': 200}

        train['annotations'][0]:
            {'area': 150930.0,
             'bbox': [0.0, 1.0, 390.0, 387.0],
             'category_id': 1,
             'id': 0,
             'image_id': 'Image_00000001.jpg',
             'iscrowd': 0,
             'segmentation': []}
        
        train['categories'][0]:
            {'id': 1, 'name': 'class-1', 'supercategory': None}
    ...
    def __init__(self, root, image_sets, preproc=None, target_transform=None,
        ...
        for (date, image_set) in image_sets:
            coco_name = date + '_' + image_set  # juggdet_0503_train 
    ...
    def image_path_from_index(self, name, index):
        ...
        file_name = index
        image_path = os.path.join(self._path_map[name]['_IM_DIR'], file_name)
